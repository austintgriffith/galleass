...
module.exports = {
  ...
  setSellPriceAtMarket:(accountindex,tokenName,price)=>{
    describe('#setSellPriceAtMarket()', function() {
      it('should set setSellPriceAtMarket', async function() {
        ...
        const result = await clevis("contract","setSellPrice","Market",accountindex,mainLand[0],mainLand[1],found,tokenAddress,price)
        printTxResult(result)
