...
class Land extends Component {
  ...
  render(){
    ...
    //hardcoded land for now until Land contract is deployed
    ...
    return (
      <div style={{zIndex:20,position:'absolute',left:0,top:0,width:4000}}>
        ...
        {this.landTile(500-60-87*2,"coppermountain")}
        {this.landTile(500-60-87,"corn")}
        {this.castleTile(500,"0x2ed971372cea3a5e21b24e4a8697e0b264b61b56")}
        ...
        {this.edgeTile(2000+60+120+87*4,"right")}




        {this.edgeTile(3400-60-87*2,"left")}
        {this.landTile(3400-60-87*2,"forest")}
        {this.landTile(3400-60-87,"mountain")}
        {this.courthouseTile(3400,"0xab5801a7d398351b8be11c439e05c5b3259aec9b")}
        {this.edgeTile(3400+60,"right")}
